...
class PatientConsent extends StatefulWidget {
  const PatientConsent({super.key});
            ...
            SizedBox(height: 5.0,),
              Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.fromLTRB(5.0, 0.0, 800.0, 0.0),
                    child: Container(
                      height: 40.0,
                      child: TextField(
              ...
              Column(
                children: [
                  Text('Please ensure to forward this referral form along'
                      ' with any accompanying medical records to the reffered'
                      ' specialist or facility. Thank you for your attention to this matter.',
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 10,
                    ),
